...
export const APPS = [
  ...
  { id: "image",      name: "Image Gen",   icon: "fa-image",         color: "#00F0FF", Component: lazy(() => import("../apps/AIChat")),        group: "ai" },
  { id: "voice",      name: "Voice",       icon: "fa-microphone",    color: "#00F0FF", Component: lazy(() => import("../apps/Voice")),         group: "ai" },
  { id: "memory",     name: "Memory",      icon: "fa-brain",         color: "#00F0FF", Component: lazy(() => import("../apps/AIChat")),        group: "ai" },
  ...
  { id: "calendar",   name: "Calendar",    icon: "fa-calendar",      color: "#FB923C", Component: lazy(() => import("../apps/Tasks")),         group: "productivity" },

  // ─── Media ─────────────────────────────────────────────────────────────
  { id: "music",      name: "Music",       icon: "fa-music",         color: "#F472B6", Component: lazy(() => import("../apps/Music")),         group: "media" },
  { id: "videos",     name: "Videos",      icon: "fa-video",         color: "#F472B6", Component: lazy(() => import("../apps/Browser")),       group: "media" },
  { id: "watchlist",  name: "Watchlist",   icon: "fa-film",          color: "#F472B6", Component: lazy(() => import("../apps/Browser")),       group: "media" },

  // ─── System ────────────────────────────────────────────────────────────
  { id: "files",      name: "Files",       icon: "fa-folder",        color: "#60A5FA", Component: lazy(() => import("../apps/Notes")),         group: "system" },
  { id: "clipboard",  name: "Clipboard",   icon: "fa-clipboard",     color: "#60A5FA", Component: lazy(() => import("../apps/Notes")),         group: "system" },
  ...
  { id: "analytics",  name: "Analytics",   icon: "fa-chart-pie",     color: "#39FF14", Component: lazy(() => import("../apps/Finance")),       group: "data" },

  // ─── Social ────────────────────────────────────────────────────────────
  { id: "nebula",     name: "Nebula Chat", icon: "fa-satellite-dish", color: "#A855F7", Component: lazy(() => import("../apps/Browser")),       group: "social" },
];
